  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 font-body",
  {
    variants: {
      variant: {
        ...
        gold: "bg-gradient-to-r from-gold to-gold-light text-primary-foreground font-semibold shadow-lg hover:shadow-xl hover:scale-105 transform",
        goldOutline: "border-2 border-primary text-primary hover:bg-primary hover:text-primary-foreground font-semibold",
        hero: "bg-gradient-to-r from-gold to-gold-light text-primary-foreground font-bold shadow-lg hover:shadow-xl hover:scale-105 transform text-base tracking-wide uppercase",
        whatsapp: "bg-[#25D366] text-white font-semibold hover:bg-[#20BD5A] shadow-lg hover:scale-105 transform",
      },
      size: {
